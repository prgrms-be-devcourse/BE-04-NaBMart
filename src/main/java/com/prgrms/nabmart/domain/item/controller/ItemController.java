...
public class ItemController {
    ...
    @GetMapping("/new")
    public ResponseEntity<FindItemsResponse> findNewItems(@RequestParam final int page,
        ...
        FindNewItemsCommand findNewItemsCommand = FindNewItemsCommand.of(page, pageSize, sortType);
